      ...
      modalPopUp.innerHTML = `
          ...
          <div class="switch">
            ...
            <div class="stack-and-buttons">
              ...
              <ul class='modal__btn '>
    <li>
    <a href='https://github.com/efmomoh/Mobile_View-Portforlio/pull/9' class="btn link project-linkLive fw-500 fz-17 lh-24 clr-p-500 bg-white"><span>See Live</span>
    
    <img src="/portfolio-icons/toparrow.png"></img></a>
    </li>
    <li>
    <a href='https://github.com/efmomoh/Mobile_View-Portforlio/pull/9' class="btn link project-linkSource fw-500 fz-17 lh-24 clr-p-500 bg-white"><span>See Source</span>
    
    <img src="/portfolio-icons/github.png"></img></a>
    </li>
    </ul>
            </div>
          </div>
